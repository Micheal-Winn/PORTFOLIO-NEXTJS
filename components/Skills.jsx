    ...
    <section id='skills' className=' w-full lg:h-screen p-2'>
        <div className=' max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
            ...
            <div className=' grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
                ...
                <div className=' p-6 shadow-xl rounded-xl hover:scale-105 transition-all ease-in duration-300'>
                ...
                <div className=' p-6 shadow-xl rounded-xl hover:scale-105 transition-all ease-in duration-300'>
                    <div className=' grid grid-cols-2 gap-4 justify-center items-center'>
                        <div className=' m-auto'>
                            <Image src='/assets/skills/bootstrap2.png' width='64' height={'64'} alt='/'/>
                        </div>
                        <div className=' flex flex-col items-center justify-center'>
                            <h3>Bootstrap</h3>
                        </div>
                ...
                <div className=' p-6 shadow-xl rounded-xl hover:scale-105 transition-all ease-in duration-300'>
                    <div className=' grid grid-cols-2 gap-4 justify-center items-center'>
                        <div className=' m-auto'>
                            <Image src='/assets/skills/redux6.png' width='64' height={'64'} alt='/'/>
                        </div>
                        <div className=' flex flex-col items-center justify-center'>
                            <h3>Redux</h3>
                        </div>
