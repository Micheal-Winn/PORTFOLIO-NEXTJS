...
const Main = () => {
  return (
    <section id='main' className=' w-full h-screen text-center'>
        <div className=' max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
            <div>
                ...
                <div className='flex items-center justify-between max-w-[330px] m-auto py-4'>
                    <div className=' hover:text-[#5651e5] rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 transition-all ease-in duration-300'>
                        <FaLinkedinIn/>
                    </div>
                    <div className=' hover:text-[#5651e5] rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 transition-all ease-in duration-300'>
                        <FaGithub/>
